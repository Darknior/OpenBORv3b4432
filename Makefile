...
ifdef BUILD_WIN
LIBS           += -lpsapi -lopengl32 -lwinmm -lole32 -loleaut32 -limm32 -lversion -mwindows
endif
...
ifdef BUILD_WII
ifdef BUILD_ELM
LIBS           += -lelm -lwiiuse -lbte -lasnd -logc
else
LIBS           += -lwiiuse -lbte -lfat -lasnd -logc
endif
endif
...
version:
	...
	@echo
	@echo "Copyright (c) 2004 - 2014 OpenBOR Team"
	@echo "-------------------------------------------------------"
